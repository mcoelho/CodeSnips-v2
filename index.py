...
print "<a href=http://web.cs.dal.ca/~coleho/oop/index.py><img src='Media/logo.gif' alt='logo'></a><hr />"

print "<div id = 'navblock'>"
print "<ul>"
print "<li><a style='color:black' href=http://web.cs.dal.ca/~coleho/oop/index.py>Home</a></li>"
