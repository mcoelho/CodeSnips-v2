...
print "<a href=http://web.cs.dal.ca/~yzhang/oop/index.py><img src='Media/logo.gif' alt='logo'></a><hr />"
...
print "<li><a href=http://web.cs.dal.ca/~yzhang/oop/login.py>Log-in</a></li>"
print "</ul>" 
print "</div>"
