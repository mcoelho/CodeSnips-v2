...
cmd = dbCommands.UpdateOnDatabaseCommand("Snippet", "language='"+snippetLang+"', version='"+snippetVersion+"', title='"+snippetTitle+"', description='"+snippetDesc+"', code='"+snippetCode+"'", "id="+snippetId)
cmd.execute()
