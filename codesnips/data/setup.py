...
if 'administrator' in args:
	if args['administrator'] == 'admin123':
		...
		c.execute('''CREATE TABLE "User" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE, "userHistory" INTEGER, "name" TEXT NOT NULL, "email" TEXT NOT NULL UNIQUE, "password" TEXT, "dob" TEXT, "bio" TEXT, "specialization" TEXT, "gravatarLink" TEXT, "favorites" TEXT, "permissions" INTEGER NOT NULL DEFAULT 1)''')
		c.execute('''CREATE TABLE "Snippet" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE, "userId" INTEGER NOT NULL DEFAULT 0, "upvotes" INTEGER NOT NULL DEFAULT 0, "downvotes" INTEGER NOT NULL DEFAULT 0, "lastChanged" TEXT, "title" TEXT NOT NULL, "revisionRequest" INTEGER, "description" TEXT NOT NULL, "code" TEXT NOT NULL, "language" INTEGER NOT NULL,)''')
